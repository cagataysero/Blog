            ...
            <div className="flex navbarWidth  justify-between">
                <div className="w-3/4 singleImageWidth mt-6 ">
                    ...
                    <div className="mt-3 flex text-center justify-between">
                        <div className="flex">
                            <img className="w-16 h-16 rounded-full" src="https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
                            <div className="mt-2 ml-3 ">
                                <span className="flex font-bold">Çağatay</span>
                                <p>Posted 3 days ago</p>
                            </div>
                        </div>
                        <div className="flex mt-4">
                            <Link to={`/write?edit=2`}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-4 text-green-700">
                    ...
                    <h1 className="flex font-bold my-8">Lorem ipsum dolor sit amet</h1>
                    <p className="tracking-wider text-justify">Lorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor sit amet </p>
